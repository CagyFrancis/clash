...
public class LLVMIRLexer extends Lexer {
	...
	public static final int
		...
		T__485=486, T__486=487, Comment=488, WhiteSpace=489, IntLit=490, FloatLit=491, 
		StringLit=492, GlobalIdent=493, LocalIdent=494, LabelIdent=495, AttrGroupId=496, 
		ComdatName=497, MetadataName=498, MetadataId=499, IntType=500, DwarfTag=501, 
		DwarfAttEncoding=502, DiFlag=503, DispFlag=504, DwarfLang=505, DwarfCc=506, 
		ChecksumKind=507, DwarfVirtuality=508, DwarfMacinfo=509, DwarfOp=510;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__483", "T__484", "T__485", "T__486", "AsciiLetter", "Letter", "EscapeLetter", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'!DIObjCProperty'", "'!DIStringType'", "'!DISubprogram'", "'!DISubrange'", 
			"'!DISubroutineType'", "'!DITemplateTypeParameter'", "'!DITemplateValueParameter'", 
			"'!GenericDINode'", "'tag:'", "'header:'", "'operands:'", "'name:'", 
			"'type:'", "'defaulted:'", "'value:'", "'flags:'", "'|'", "'cc:'", "'align:'", 
			"'allocated:'", "'annotations:'", "'arg:'", "'associated:'", "'attributes:'", 
			"'baseType:'", "'checksum:'", "'checksumkind:'", "'column:'", "'configMacros:'", 
			"'containingType:'", "'count:'", "'debugInfoForProfiling:'", "'declaration:'", 
			"'directory:'", "'discriminator:'", "'dataLocation:'", "'dwarfAddressSpace:'", 
			"'dwoId:'", "'elements:'", "'emissionKind:'", "'DebugDirectivesOnly'", 
			"'FullDebug'", "'LineTablesOnly'", "'NoDebug'", "'encoding:'", "'entity:'", 
			"'enums:'", "'exportSymbols:'", "'expr:'", "'extraData:'", "'file:'", 
			"'filename:'", "'getter:'", "'globals:'", "'identifier:'", "'imports:'", 
			"'includePath:'", "'inlinedAt:'", "'isDecl:'", "'isDefinition:'", "'isImplicitCode:'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ChecksumKind", "DwarfVirtuality", "DwarfMacinfo", "DwarfOp"
		};
	}
